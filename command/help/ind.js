...
exports.noregis = (pushname) =>{
	return`Halo ${pushname} 👋🏻, lu belum daftar. Ketik .daftar untuk mendaftar`
	}
exports.regis = () =>{
...
Sukses, sekarang ketik .menu untuk melihat 
fitur bot, don't spam bots!
`
	}
...
▢ Kelamin :
▢ Askot :
╰─ ᝬ _Patuhi Rules Group Ya~_`
      }
exports.leave = () =>{
	return`
│
╰─ ᝬ _Balik Lagi Wajib Bawa Nasi Kotak_ >_<`
}
